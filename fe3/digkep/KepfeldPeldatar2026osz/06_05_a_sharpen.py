...
def on_tb_changed_w(pos):
    ...
    cv2.imshow('im_sharpen', im_sharpen)
...
# Megjelenítjük az eredetit, hogy megfelelő legyen az ablak mérete a trackbar-hoz
cv2.imshow('im_sharpen', im)
cv2.createTrackbar('W', 'im_sharpen', 25, 50, on_tb_changed_w)
