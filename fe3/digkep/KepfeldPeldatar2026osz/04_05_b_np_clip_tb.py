...
# im_src = cv2.imread('KozuzemiOraallasok/1313518560104.jpg', cv2.IMREAD_GRAYSCALE)
# im_src = cv2.imread('KozuzemiOraallasok/1313518629386.jpg', cv2.IMREAD_GRAYSCALE)
# im_src = cv2.imread('KozuzemiOraallasok/1313575791550.jpg', cv2.IMREAD_GRAYSCALE)
# im_src = cv2.imread('KozuzemiOraallasok/1313575818222.jpg', cv2.IMREAD_GRAYSCALE)
...
cv2.createTrackbar('Also', 'im_th_clip', th_lower, 255, trackbar_lower)
cv2.createTrackbar('Felso', 'im_th_clip', th_upper, 255, trackbar_upper)
cv2.createTrackbar('Mukodes', 'im_th_clip', th_mode, 1, trackbar_mode)
